 ...
 * Grid Result
 */
export const SELECT_GRID_RESULT_TAB = 'SELECT_GRID_RESULT_TAB'; //Like select a specific view tab => load corresponding avl query's criterias AND load corresponding grid result
